...
class API {
    ...
    private function get_items( $type = 'items' ) {
        ...
        $query = sprintf(
            '{ %s( %s page: %s, per_page: %s, platform: "%s"%s%s ) { total_page, current_page, data { id, name, rating, type, slug, favourite_count, %s thumbnail, price, author{ display_name, name, joined }, category{ id, name } } } }',
            $type,
