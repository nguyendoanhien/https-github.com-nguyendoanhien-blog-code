...
class Admin
{
    ...
    {
        $this->pages[] = add_menu_page(__('PortfolioHub Portfolio Gallery', 'pfhub_portfolio'), __('Portfolio Gallery', 'pfhub_portfolio'), 'delete_pages', 'portfolios_pfhub_portfolio', array(
            AdminGrids::class,
            'load_portfolio_page'
        ), 'dashicons-layout');
